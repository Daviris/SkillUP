...
<div class="bg-gray-800 rounded-lg border-2 border-amber-700 shadow-xl p-6">
    <h1 class="text-4xl font-bold text-amber-300 mb-6" style="font-family: 'VT323', monospace;">Mis Cursos Adquiridos</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-gray-700 rounded-lg border border-amber-600 p-5 shadow hover:shadow-amber-900/50 transition">
            ...
            <p class="text-sm text-gray-400 mt-2">Instructor: <?= htmlspecialchars($curso['instructor_nombre'] ?? 'N/A') ?></p>
            <div class="mt-4">
                <a href="/cursos/<?= $curso['id'] ?>" class="text-amber-400 hover:underline">Ver detalles</a>
            </div>
        </div>
        <?php endforeach; ?>
    </div>
    ...
    <div class="text-center py-12 bg-gray-900/50 rounded-lg border border-dashed border-amber-700">
        ...
        <a href="/cursos" class="inline-block mt-4 bg-amber-700 hover:bg-amber-600 text-white font-bold py-2 px-4 rounded border border-amber-500 shadow transition">
            Explorar cursos
        </a>
    </div>
    <?php endif; ?>
