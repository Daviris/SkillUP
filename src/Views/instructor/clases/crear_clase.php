...
$cancelUrl = '/instructor'; // valor por defecto
if (!empty($clase['curso_id'])) {
    $cancelUrl = '/instructor/cursos/' . $clase['curso_id'] . '/clases';
    ...
    <div class="card" style="padding:2rem;">
        ...
        <form method="POST" action="<?= $accion === 'Crear' ? '/instructor/clases/guardar' : '/instructor/clases/actualizar/' . ($clase['id'] ?? '') ?>" enctype="multipart/form-data" id="clase-form">
            ...
            <div style="display:flex; gap:1rem; margin-top:2rem;">
                <button type="submit" class="btn btn-primary"><?= htmlspecialchars($accion) ?></button>
