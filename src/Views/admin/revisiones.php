<?php ob_start(); ?>
<h1 class="font-rpg" style="font-size:2.5rem; color:#fbbf24; margin-bottom:1.5rem;">📋 Cursos en Revisión</h1>
            ...
            <tr>
                ...
                <td>
                    <div style="display:flex; gap:0.5rem; flex-wrap:wrap;">
                        <a href="/admin/revisiones/ver-clases/<?= $curso['id'] ?>" class="btn btn-secondary btn-sm">📚 Ver clases</a>
                        <a href="/admin/revisiones/aprobar/<?= $curso['id'] ?>" class="btn btn-success btn-sm">✅ Aprobar</a>
                        <button onclick="mostrarRechazo(<?= $curso['id'] ?>)" class="btn btn-danger btn-sm">❌ Rechazar</button>
